...
function createEngine(opts = {}) {
  ...
  const exportScript = `
    globalThis.__ENGINE__ = {
      ...
      choosePhysicalCloseAngle, prepareDartMoveCandidate,
      evaluateEndpoint, findPhysicalSweepLimit,
      findMaxApplicableMagnitude, selectRotationSign, resolveRequestedAngle,
      withSelfXBaseline, rotationLegBarrier,
